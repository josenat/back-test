...
public class InsertExpedienteParamDTO {
	...
	public String getCdgoEntorno() {
		return cdgoEntorno;
	}

	public void setCdgoEntorno(String cdgoEntorno) {
	...
	public Integer getCdgoAuxCab() {
		return cdgoAuxCab;
	}

	public void setCdgoAuxCab(Integer cdgoAuxCab) {
