...
public class GetActasActivasPersonaDTO {
	...
	private String cdgo_idInstru;
	private String cdgo_idExa;
	...
	public String getCdgo_idInstru() {
		return cdgo_idInstru;
	}
	public void setCdgo_idInstru(String cdgo_idInstru) {
		this.cdgo_idInstru = cdgo_idInstru;
	}
	public String getCdgo_idExa() {
		return cdgo_idExa;
	}
	public void setCdgo_idExa(String cdgo_idExa) {
		this.cdgo_idExa = cdgo_idExa;
	}	
