...
public class ImpPsicofisico extends ImpPdfWriterAux {

	private ImprimirCts objCte = new ImprimirCts();

	private GetPsicofisico objPsicofisico = null;
	private String sFinal = "\r\n";

	public ImpPsicofisico(GetPsicofisico psicofisico, Document document, PdfWriter pdfWriter, Font defaultFont) {
		super(document, pdfWriter, defaultFont);
		this.objPsicofisico = psicofisico;
	}
	...
	private Paragraph IPS_Parrafo001N() {
		...
		Phrase Linea000 = new Phrase(this.objPsicofisico.GetLinea_000(), font);
		Phrase Linea001 = new Phrase(this.objPsicofisico.GetLinea_001(), this.defaultFont);
	...
	private Paragraph IPS_Parrafo001() {
		...
		Phrase LineaB = new Phrase(this.GetLinea_Blanco(), this.defaultFont);
		Phrase Linea000 = new Phrase(this.objPsicofisico.GetLinea_000(Orden), font);
		Phrase Linea001 = new Phrase(this.objPsicofisico.GetLinea_001(Orden), this.defaultFont);
		Phrase Linea002 = new Phrase(this.objPsicofisico.GetLinea_002(Orden), this.defaultFont);
		Phrase Linea003 = new Phrase(this.objPsicofisico.GetLinea_003(Orden), this.defaultFont);
		Phrase Linea004 = new Phrase(this.objPsicofisico.GetLinea_004(Orden), this.defaultFont);
	...
	private Paragraph IPS_Parrafo001(int Orden) {
		...
		if (Orden == 0) {
			Linea000 = new Phrase(this.objPsicofisico.GetLinea_000(Orden), font);
		}
		Phrase Linea001 = new Phrase(this.objPsicofisico.GetLinea_001(Orden), this.defaultFont);
		Phrase Linea002 = new Phrase(this.objPsicofisico.GetLinea_002(Orden), this.defaultFont);
		Phrase Linea003 = new Phrase(this.objPsicofisico.GetLinea_003(Orden), font);
		Phrase Linea004 = new Phrase(this.objPsicofisico.GetLinea_004(Orden), this.defaultFont);
