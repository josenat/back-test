...
public class Tbasg102Titulocon {
	
	public Tbasg102Titulocon(Long cdgoTit, Integer cdgoPersona, Date fchaOtorgado, String desgTiptit, String desgUsuact,
			Date fchaAct, String mrcaActivo, String desgSoloram, Date fchaTipejerprof) {
